...
const About = () => {
  ...
  return (
    <>
        ...
        <div className="flex justify-evenly gap-6 lg:gap-0 items-center p-6 pt-8 bg-zinc-100 about-container flex-col-reverse lg:flex-row ">
            <div className="lg:w-1/3 w-full lg:block lg:gap-0 gap-8 lg:px-0 sm:px-4 md:flex about-txt">
                ...
                <div>
                    ...
                    <p className='opacity-70 text-sm mb-4 :text-zinc-200 :opacity-80 block'>At AstroCart, we believe in the power of convenience, choice, and exceptional service. Our journey began with a simple yet ambitious goal: to create an online shopping destination that offers an unparalleled experience for our customers.</p>
                </div>
                <div>
                    <h2 className='md:text-4xl text-2xl text-reddish mb-2 font-bold text-red-600'>Our Story</h2>
                    <p className='opacity-70 text-sm :text-zinc-200 :opacity-80'>Founded in 2024, AstroCart quickly established itself as a trusted name in the world of online retail. What sets us apart is our unwavering commitment to quality, reliability, and innovation. With a team of dedicated professionals and a passion for exceeding expectations, we've curated a diverse range of products to cater to every need and preference.</p>
                </div>
            </div>
        ...
        <div className="flex justify-evenly items-center p-6 pt-2 bg-zinc-100 about-container flex-col lg:flex-row :bg-gray-900 lg:gap-0 gap-6">
            ...
            <div className="lg:w-1/3 w-full about-txt lg:block md:flex  lg:gap-0 gap-8 lg:px-0 sm:px-4">
                <div>
                    ...
                    <p className='opacity-70 text-sm mb-4 :text-zinc-200 :opacity-80'>Whether you're searching for the latest trends in fashion, cutting-edge gadgets, or everyday essentials, AstroCart has you covered. Our carefully curated selection features top brands and exclusive offerings, ensuring that you find exactly what you're looking for, every time you visit.</p>
                </div>
                <div>
                    <h2 className='md:text-4xl text-2xl text-reddish mb-2 font-bold text-red-600'>Customer Satisfaction</h2>
                    <p className='opacity-70 text-sm :text-zinc-200 :opacity-80'>At AstroCart, customer satisfaction is our top priority. From seamless browsing and secure transactions to prompt delivery and responsive customer support, we go above and beyond to ensure that your shopping experience is nothing short of exceptional.</p>
                </div>
            </div>
        </div>

        <div className="lol text-center p-4 pb-6 opacity-90 bg-zinc-100 :bg-gray-900 :text-zinc-400 :opacity-95">
