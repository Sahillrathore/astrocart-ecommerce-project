...
const Login = ({ login, setLogin }) => {
    ...
    return (
        <>
            ...
            <div className="py-2 sm:py-8 lg:py-3 fixed lg:top-[7%] sm:top-[6%] xs:top-[10%] top-[10%] rounded-xl lg:pb-8 md:left-[23%] sm:left-[13%] xs:left-[13%] left-[4%] md:w-[55%] sm:w-3/4 xs:w-3/4 w-11/12 bg-black/70 backdrop-blur-md z-50">
                <div className="mx-aut max-w-screen-2xl px-2 sm:px-4 md:px-8 relative">
                    <h2 className="mb-4 text-center text-2xl font-bold text-gray-100 md:mb-3 lg:text-3xl">
                        Login
                    </h2>
                    <button
                    ...
                    <form className="mx-auto max-w-2xl rounded-lg border">
                        <div className="flex flex-col gap-4 p-4 md:p-5">
                            <div>
                                <label
                                    htmlFor="username"
                                    className="mb-2 inline-block text-sm text-gray-100 sm:text-base"
                                >
                                    Name
                                </label>
                                <input
                                    ...
                                    required
                                    placeholder='Name'
                                    className="w-full rounded border bg-gray-50 px-3 py-1 text-gray-600 outline-none ring-indigo-300 transition duration-100 focus:ring"
                                />
                            </div>
                            <div>
                                <label
                            ...
                            <button className="block rounded-lg bg-gray-700 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-800 focus-visible:ring active:bg-gray-600 md:text-base"
